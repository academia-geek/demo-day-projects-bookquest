        ...
        <div>
            ...
            <div style={{ width: '100%', minHeigh: '100px' }}>
                <div className='contInfoLanding' style={{ width: '100%', minHeight: '600px', position: 'relative', justifyContent: "space-around", padding: "60px"}}>
                    <div style={{display:"flex", gap:"40px", position:"relative", justifyContent:"center", alignItems:"center"}}>
                        <img style={{ position: "absolute", left: "32%", bottom: "-30px" }} src='https://res.cloudinary.com/dtmapxnao/image/upload/v1709759716/Open-Day/lector_hsllte.png' />
                        ...
                        <img style={{ position: "absolute", top: "-30px", right: "-50px" }} src='https://res.cloudinary.com/dtmapxnao/image/upload/v1709759716/Open-Day/libritos_bodyqj.png' />
