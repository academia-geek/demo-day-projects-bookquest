        ...
        <div style={{ width: '100%', minHeigh: '100px' }}>
            ...
            <div className='contInfoLanding' style={{ width: '100%', minHeight: '600px', position: 'relative', padding:"60px", backgroundColor:"rgb(72, 66, 69)", flexDirection:"column", gap:"35px"}}> 
                <div style={{display:"flex", gap:"40px"}}>
                    <div style={{backgroundColor:"rgb(255,255,255)", padding:"40px", paddingLeft:"60px", paddingRight:"60px", borderRadius:"10px", width:"max-content"}}>
                ...
                <div style={{display:"flex", gap:"40px"}}>
                    <div style={{backgroundColor:"rgb(255,255,255)", padding:"40px", paddingLeft:"60px", paddingRight:"60px", borderRadius:"10px", width:"max-content"}}>
                        <p className='texTo2'>Nuestro patrimonio bibliográfico abarca una<br></br>amplia variedad de temas y autores, disponibles<br></br>para
                        consulta en nuestra plataforma. Estos<br></br>documentos, están disponibles para consulta<br></br>en nuestra plataforma.</p>
                    </div>
                    <div style={{backgroundColor:"rgb(255,255,255)", padding:"40px", paddingLeft:"60px", paddingRight:"60px", borderRadius:"10px", width:"max-content"}}>
                ...
                <img style={{position:"absolute", left:"42%", bottom:"40%", width:"150px"}} src='https://res.cloudinary.com/dtmapxnao/image/upload/v1709759715/Open-Day/LogoBibioteca_uyy7nf.png'/>
            </div>
        </div>
        <Footer />
    </div>
