...
export default function Footer() {
    return (
        <div style={{display: 'flex', flexDirection: 'column' , width: '100%'}}>
            <footer className="footer p-10 bg-base-200 text-base-content" style={{ backgroundColor: "rgb(72, 66, 69, 0.72)" , color: "white" }}>
                <nav>
                    <h6 className="footer-title">Services</h6>
                    <a className="link link-hover">Servicio a Domicilio</a>
                    <a className="link link-hover">Entre a un efectivo Tiempo</a>
                    <a className="link link-hover">Entre a un efectivo Tiempo</a>
                    <a className="link link-hover">Entre a un efectivo Tiempo</a>
                </nav>  
                <nav>
                    <h6 className="footer-title">Company</h6>
                    <a className="link link-hover">Varias  Empresas asociadas</a>
                    <a className="link link-hover">Confama</a>
                    <a className="link link-hover">Libreria de Medellin</a>
                    <a className="link link-hover">Libreria de Itagui</a>
                </nav>
            </footer>
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300" style={{ backgroundColor: "rgb(72, 66, 69, 0.82)" , color: "white" }}>
